        ...
        <div className=''>
            <footer className="footer p-10 bg-gradient-to-r from-violet-300 to-fuchsia-300 text-base-content">
                <div className='my-auto'>
                    ...
                    <div>
                        ...
                        <div className='flex gap-0 subscribe'>
                ...
                <div>
                    ...
                    <a className="link link-hover">Basic</a>
                    <a className="link link-hover">Coaching</a>
                    <a className="link link-hover">Competitive</a>
            ...
            <footer className="footer items-center py-3 px-10 bg-gradient-to-r from-violet-200 to-fuchsia-200">
                ...
                <div className="text-violet-700">
                    <p>Copyright © 2023 - All right reserved by apex sports</p>
                </div>
                </div>
