    ...
    return (
        <div className="w-[600px] mx-auto">
            ...
            <Elements stripe={stripePromise}>
                <PaymentForm price={payingValue} instructor={payingInstructor} class_name={payingClassName} image={payingClassImage} id={payingId}></PaymentForm>
            </Elements>
